            ...
            <div className="py-6 flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
                ...
                >
                    <p className="text-textWhite p-4 text-lg sm:text-xl sm:leading-7">
                        ...
                        TypeScript, Python, HTML, CSS, React.js,Node.js, Express.js, MongoDB, Tailwind CSS, and Git.
                            ...
                            <ul className="list-disc pl-2 flex flex-col gap-4">
                                ...
                                >
                                    ...
                                    <div className="mt-2 flex gap-4 items-center">
                                        ...
                                        <span>
                                            <p>
                                            • Completed a job simulation as a Goldman Sachs governance analyst responsible for assessing IT security and suggesting
improvements.</p>
<p>
• Identified that the company was using an outdated password hashing algorithm by cracking passwords using Hashcat.
</p>
<p>
• Wrote a memo for my supervisor summarizing a range of proposed uplifts to increase the company’s level of password
protection including extending minimum password length and using a dedicated hashing algorithm.
